...
public class UserCommunityResponseDto extends ResponseDto{
    ...
    public static ResponseEntity<UserCommunityResponseDto> success() {
        UserCommunityResponseDto reponseBody = new UserCommunityResponseDto();
        return ResponseEntity.status(HttpStatus.OK).body(reponseBody);
    }

    public static ResponseEntity<ResponseDto> idNotFound() {
        ResponseDto reponseBody = new ResponseDto( ResponseCode.ID_NOT_FOUND , ResponseMessage.ID_NOT_FOUND );
    ...
    public static ResponseEntity<ResponseDto> communityListIdNotFound() {
        ResponseDto responeBody = new ResponseDto( ResponseCode.COMMUNITY_LIST_NOT_FOUND , ResponseMessage.COMMUNITY_LIST_NOT_FOUND );
