...
@NoArgsConstructor
@AllArgsConstructor
public class GetByContentTypeUserCommunityResponseDto extends ResponseDto{
    ...
    // Entity -> DTO 변환 생성자
    public GetByContentTypeUserCommunityResponseDto(UserCommunityEntity entity) {
    ...
    public static ResponseEntity<List<GetByContentTypeUserCommunityResponseDto>> success(List<UserCommunityEntity> userCommunityList) {
        List<GetByContentTypeUserCommunityResponseDto> responseList = userCommunityList.stream()
                .map(GetByContentTypeUserCommunityResponseDto::new) // Entity를 DTO로 변환
